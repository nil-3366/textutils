...
// to set data type of props and isrequired is for throwing the error if we do not mention props
Navbar.propTypes= {
    title:PropTypes.string.isRequired,
    aboutText:PropTypes.string.isRequired               
}

// to set default props if we dont mention props in app.js it will take defsult props from here
Navbar.defaultProps={
